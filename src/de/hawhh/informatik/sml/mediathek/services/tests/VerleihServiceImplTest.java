...
import de.hawhh.informatik.sml.mediathek.services.VerleihProtokollierer;
...
public class VerleihServiceImplTest
{
    ...
    public VerleihServiceImplTest() throws IOException
    {
        ...
        _service = new VerleihServiceImpl(kundenstamm, medienbestand,
                new ArrayList<Verleihkarte>(), _protokollierer);
    }
